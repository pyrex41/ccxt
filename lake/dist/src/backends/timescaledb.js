        ...
        for (let i = 0; i < points.length; i += batchSize) {
            ...
            try {
                ...
                for (const point of batch) {
                    const candle = point.data;
                    valueStrings.push(`(to_timestamp($${paramIndex} / 1000.0), $${paramIndex + 1}, $${paramIndex + 2}, $${paramIndex + 3}, $${paramIndex + 4}, $${paramIndex + 5}, $${paramIndex + 6}, $${paramIndex + 7}, $${paramIndex + 8})`);
                    values.push(point.timestamp, point.exchange, point.symbol, point.timeframe, candle.open, candle.high, candle.low, candle.close, candle.volume);
                    paramIndex += 9;
                }
                const query = options?.upsert
                    ? `
...
//# sourceMappingURL=timescaledb.js.map